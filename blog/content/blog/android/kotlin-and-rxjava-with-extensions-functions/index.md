---
title: "Kotlin and RxJava with extension functions"
linkTitle: "Kotlin and RxJava with extension functions"
date: 2018-01-07
...
- src: "featured-title.jpg"
  params:
    byline: "Image from [unsplash](https://unsplash.com/photos/L94dWXNKwrY)"
--- 
...
# TL;DR;
[The full code is available here]({{< sourcefile "/examples/kotlin-and-rxjava-with-extensions-functions/src/main/java/com/jacekmarchwicki/examplerxextensions/MainActivity.kt" >}})
...
[Presenters and UI implementation]({{< sourcefile "/examples/kotlin-and-rxjava-with-extensions-functions/src/main/java/com/jacekmarchwicki/examplerxextensions/MainActivity.kt" >}})
...
If you would like to see how to test it, check this out: [Using schedulers while testing your code]({{< ref "/blog/android/using-schedulers-while-testing-your-code/index.md" >}})
